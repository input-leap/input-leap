                ...
                void* eventTarget)
{
    ...
    events->add_event(Event(EventType::FILE_CHUNK_SENDING, eventTarget, sizeMessage));
    ...
    while (true) {
        ...
        events->add_event(Event(EventType::FILE_KEEPALIVE, eventTarget));
        ...
        events->add_event(Event(EventType::FILE_CHUNK_SENDING, eventTarget, fileChunk));
    ...
    events->add_event(Event(EventType::FILE_CHUNK_SENDING, eventTarget, end));
                ...
                void* eventTarget)
{
    ...
    events->add_event(Event(EventType::CLIPBOARD_SENDING, eventTarget, sizeMessage));
    ...
    while (true) {
        ...
        events->add_event(Event(EventType::CLIPBOARD_SENDING, eventTarget, dataChunk));
    ...
    events->add_event(Event(EventType::CLIPBOARD_SENDING, eventTarget, end));
